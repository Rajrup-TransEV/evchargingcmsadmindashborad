...
const Faqupdate = () => {
    ...
    const handelSubmit = async(e)=>{
        ...
        try {
            ...
            const response = await fetch(`${rooturi}/users/faqupdate`,{
                method:'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'apiauthkey': apikey,
        ...
        const apikey = import.meta.env.VITE_API_KEY;
          try {
              ...
              if(data){
                ...
                const pathfinder = "faqupdate.jsx"
    ...
    <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      >
        <div className="max-w-xl lg:max-w-3xl">
          ...
          <form action="#" onSubmit={handelSubmit} className="mt-8 grid grid-cols-6 gap-6">
