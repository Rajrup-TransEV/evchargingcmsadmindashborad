...
//   useEffect(() => {
//     const fetchmonthlyrevData = async () => {
//       const rooturi = import.meta.env.VITE_ROOT_URI;
//       const apikey = import.meta.env.VITE_API_KEY;

//       try {
//         const response = await fetch(`${rooturi}/admin/monthlyrev`, {
//           method: "GET",
//           headers: {
//             'Content-Type': 'application/json',
//             'apiauthkey': apikey,
...
//           <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">This Month revenue</h2>
//           {/* Menu button */}
...
function DashboardCard02() {
  ...
  useEffect(() => {
    const fetchmonthlyrevData = async () => {
      ...
      try {
        ...
        toast('Failed to fetch monthly revenue');
        settodayrev(0);
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="relative col-span-full sm:col-span-6 xl:col-span-4 overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 shadow-lg">
      {/* Glass overlay */}
      ...
      <div className="relative p-6">
        ...
        <header className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-xs text-emerald-100">Current month performance</p>
          </div>

          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link className="text-sm text-gray-700 hover:text-black flex py-1 px-3" to="#0">View details</Link>
            </li>
            <li>
              <Link className="text-sm text-gray-700 hover:text-black flex py-1 px-3" to="#0">Refresh</Link>
            </li>
          </EditMenu>
        </header>
        ...
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/20 text-white text-2xl font-bold">
            ₹
          </div>
          ...
          {loading ? (
            ...
            <div>
              ...
              <p className="text-xs text-emerald-100">Month-to-date</p>
            </div>
          )}
        </div>
        ...
        <div className="mt-6 flex justify-between items-center">
          <span className="text-xs text-emerald-100">This Month · IST</span>
